...
type TCallback = ((value: string | number) => { isValid: boolean, errMessage: string | null }) | undefined
const useInput = (type: "text" | "number", initData: string | number | undefined = undefined) => {
